        ...
        <Row className="home-courses">
            ...
            <Col lg={16}>
                <Row className="row-courses">
                    <Col md={6} >
                        <CardCourse
                            image={reactJsHooks} title="React JS Hooks"
                    ...
                    <Col md={6} >
                        <CardCourse
                            image={reactNative} title="React Native Expo"
                            subtitle="Intermedio - React Native Expo"
                            link="https://courses.agustinnavarrogaldon.com/react-native-expo"
                        />
                    </Col>
                    <Col md={6} >
                        <CardCourse
                            image={javaScript} title="JavaScript ES6"
                  ...
                  <Row className="row-courses">
                    <Col md={6} >
                        <CardCourse
                            image={prestaShop} title="PrestaShop"
